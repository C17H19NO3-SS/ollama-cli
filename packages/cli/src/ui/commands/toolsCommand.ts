...
const listSubCommand: SlashCommand = {
  name: 'list',
  description: 'List available Ollama CLI tools.',
...
const descSubCommand: SlashCommand = {
  ...
  description: 'List available Ollama CLI tools with descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: true,
  action: async (context: CommandContext): Promise<void> =>
...
export const toolsCommand: SlashCommand = {
  name: 'tools',
  description:
    'List available Ollama CLI tools. Use /tools desc to include descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: false,
